                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 style="float:left;">Salary Sheet Instructions</h3>
                            <a href="{{route('sheetInstructionAdd')}}"   class="btn btn-primary btn-icon-split float-right"><i class="fas fa-plus"></i>Add Salary Instruction</a>  
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="manageSalarySheetInstructionTable" width="100%" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th width="6%">SL</th>
                                        <th>Month Year</th>
...
<script>
            ...
            var table;
                $(document).ready(function() {
                    table = $('#manageSalarySheetInstructionTable').DataTable({
                        'ajax': "{{route('getSalaryInformationData')}}",
                        processing:true,
                    });
                });

                            ...
                            <td class="text-end">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" onclick="editCategory({{ $category->id }})"><i class="fas fa-edit me-1"></i>Edit</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="confirmDelete({{ $category->id }})"><i class="fas fa-trash-alt me-1"></i>Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
              ...
              @csrf
                  ...
                  <input type="hidden" name="editId" id="editId">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <img id="editShowImage" src="{{url('upload/images/no_image.png')}}" style="width: 100px;height: 80px; border:1px solid #000000"><br><a href="#" onclick="removeImage()" style="margin-left:20px;"> <i class="fas fa-trash-alt me-1"></i>Remove Image</a><input type="hidden" id="removeImage" name="removeImage" value="" />
                        </div>
                    </div>

...
<head>
    ...
    <title>Current Stock of Products</title>
</head>
    ...
    <main>
        ...
        <div>
            <div style="text-align: center;">
                <div class="citiestd13">Current Stock of Products</div>
                ...
                <table border="1" class="invoice-info" cellspacing="0" cellpadding="3">
                    ...
                    <tbody>
                        ...
                        @foreach ($currentStocks as $stock)
                            @php
                                $totalProducts += $stock->current_stock;
                            @endphp
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td class="citiestd15">{{ $stock->name }}</td>
                                <td class="citiestd15">{{ $stock->category_name }}</td>
                                <td class="citiestd15">{{ $stock->brand_name }}</td>
                                <td class="text-center">{{ $stock->unit_name }}</td>
                                <td class="text-center">{{ $stock->current_stock }}</td>
                                <td class="text-center">{{ $stock->purchase_price }}</td>
                                <td class="text-center">{{ $stock->sale_price }}</td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td colspan="2" class="text-center">Total Stock =</td>

        ...
        <table border="1" class="invoice-info" cellspacing="0" cellpadding="3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="text-align:right;">{{$detail->debit}} {!! Session::get('companySettings')[0]["currency"]!!}</td>
                    <td class="text-center" style="text-align:right;"> {{$detail->credit}} {!! Session::get('companySettings')[0]["currency"]!!}</td>
                </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td style="text-align:right;" style="text-align:right;"> {{$journals->voucher_amount}} {!! Session::get('companySettings')[0]["currency"] !!}</td>
                </tr>
            </tbody>
        </table>
    </div>
